...
sun = sphere(pos=(0, 0, 0), color=color.yellow, radius=3*R, trail=curve(pos=[-center]))
sun.trail.color = color.yellow

planets = [sphere(pos=a2v(r-center), radius=R, make_trail=True, trail=curve(pos=[r-center])) for r in pos]
